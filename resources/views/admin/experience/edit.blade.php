        ...
        <div class="card-body">
            ...
            <x-form.wrapper action="{{ route('admin.experiences.update', $experience->id) }}" method="POST"
                ...
                <div class="input-container   d-flex" style="max-width: 45%">
                    <input type="text" :req="true" name="tags[]" required
                        value="{{ $value ?? '' }}" class="form-control ms-2 me-2"
                        style="height: 38.95px;
                               margin-top: 34px;" placeholder="Tag Name">
            ...
            <template id="template-form">
                <div class="input-container d-flex mt-1" style="max-width: 45%;">
                    <input type="text" name="tags[]" :req="true" class="form-control ms-2 me-2"
                        placeholder="Tag Name" style="height: 38.95px; margin-top: 34px;">
                </div>
            </template>
        </div>
    </div>
