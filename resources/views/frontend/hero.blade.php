        ...
        <div class="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative hidden lg:block" id="hero-svg-container">
                <svg id="hero-interactive-svg" viewBox="0 0 500 500" class="w-full h-auto drop-shadow-2xl" style="cursor: default;">
                    ...
                    <g id="icon-code" class="floating-icon draggable-element" data-orbit-radius="100" data-orbit-offset="0" data-rest-x="250" data-rest-y="150" style="cursor: grab;" filter="url(#iconShadow)">
                    ...
                    <g id="icon-close" class="floating-icon draggable-element" data-orbit-radius="100" data-orbit-offset="3.14" data-rest-x="250" data-rest-y="350" style="cursor: grab;" filter="url(#iconShadow)">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let orbitAngle = 0;
    let orbitRotations = { outer: 0, middle: 0, inner: 0 };
    ...
    <style>
        ...
        .bg-accent\/10 { background-color: rgba(207, 63, 54, 0.1); }
