<div class="relative py-20 bg-card/10 backdrop-blur-[2px]">
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group bg-card/60 backdrop-blur-sm border border-white/5 rounded-2xl p-6 hover:border-accent/50 transition-all duration-300 flex flex-col h-full shadow-lg shadow-black/10">
                <!-- Header -->
